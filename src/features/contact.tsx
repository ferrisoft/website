...
const timeline = [
    {
        ...
        description: 'We contact you within 24 hours and help shape your project from the start. We brainstorm together, guide design and architecture, and lead you toward a clear plan, even if your idea is still forming.',
        icon: Icon.HomeIcon,
    ...
    },
    {
        ...
        description: 'You get a structured path from concept to a working product. We refine requirements, set priorities and create a delivery plan with clear milestones and no surprises.',
        icon: Icon.MapIcon,
        iconClass: 'text-zinc-200',
        iconBackgroundClass: 'bg-zinc-800',
    },
    {
        ...
        description: 'You’re always informed and involved. You get a shared Discord space with daily updates and direct access to the team, so decisions and adjustments happen quickly.',
    ...
    },
    {
        ...
        description: 'Your code is written and reviewed by engineers, not generated by AI. We use AI only to accelerate analysis and routine tasks, giving you high-quality, long-lasting code delivered faster.',
    ...
    },
    {
        ...
        description: 'You get features that matter and avoid needless complexity. We solve real user problems, design clear interfaces and keep operations simple and maintainable.',
    ...
    },
    {
        ...
        description: 'You stay supported well beyond the first release. We maintain, refine and extend your product as needs grow, keeping it fast, reliable and aligned with your business.',
        icon: Icon.HeartIcon,
...
// === Contact ===
// ===============
// const MyComponent = forwardRef<HTMLDivElement, { someProp?: string }>(
//     (props, ref) => {
...
export const Contact = React.forwardRef((props, ref) => {
    ...
    const updateCountryFromNumber = React.useCallback((number: string) => {
    ...
    const setNumber = React.useCallback((numberRaw: string) => {
    ...
    const onPhoneInputChange = React.useCallback((event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    React.useEffect(() => {
        Fetch.withTimeout("https://ipwho.is/", 5000)
            .then(data => setRegionName(Country.byIso2[data.country_code]?.name ?? ""))
    }, [setRegionName])
    ...
    React.useEffect(() => {
        ...
        async function onSubmit(e: SubmitEvent) {
            ...
            try {
                ...
                if (res.ok) {
                    console.log("ok")
                    // statusDiv.textContent = "Thanks! We'll contact you soon."
                    form.reset()
                } else {
                    console.log("error")
        ...
        <div ref={ref} className='pt-0'>
            <div className='dark-theme min-h-screen relative'>
                <Section
                    ...
                    background={
                        <div className='w-full h-full bg-zinc-900' style={{
                ...
                >
                    ...
                    <div className="lg:items-center lg:text-center lg:mx-auto">
                        ...
                        <h3>From first contact to final delivery, we build your product with clarity and care.</h3>
                    </div>
                        <div className="relative">
                                <div className="pt-16 flex justify-center flex-col lg:flex-row">
                                    ...
                                    <div className="lg:w-0 grow">
                                        <ul role="list">
                                            {timeline.map((event, eventIdx) => {
                                                const active = formSubmitted && eventIdx == 0
                                                const inactive = formSubmitted && eventIdx != 0
                                                ...
                                                return <li key={event.id} className={ Class.names(liClassName, 'transition-opacity duration-300') }>
                                                    <div className="relative pb-8">
                                                        ...
                                                        <div className="relative flex space-x-3">
                                                            ...
                                                            <div
                                                                className="flex min-w-0 flex-1 justify-between space-x-4 pt-1">
                                                                <div>
                                                                    <h4> {event.title} </h4>
                                                                    <span
                                                                        className='text-sm'> {event.description} </span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                    ...
                                    <div className={ Class.names("lg:w-0 pt-8 lg:pt-0 transition-all duration-300 overflow-hidden", formSubmitted ? '' : 'grow') }>
                                            ...
                                            <form ref={formRef} action="#" method="POST" className="lg:flex-auto">
                                                <div className="flex flex-col gap-6">
                                                    <div className='flex gap-6 flex-col sm:flex-row'>
                                                        <div className='grow'>
                                                            <label htmlFor="firstName" className="block font-semibold text-zinc-200">
                                                                First name
                                                            </label>
                                                        ...
                                                        <div className='grow'>
                                                            <label htmlFor="lastName" className="block font-semibold text-zinc-200">
                                                                Last name
                                                            </label>
                                                            <div className="mt-2.5">
                                                                <input
                                                    ...
                                                    <div>
                                                        <label htmlFor="email" className="block font-semibold text-zinc-200">
                                                            Email address
                                                        </label>
                                                        <div className="mt-2.5">
                                                            <input
                                                    ...
                                                    <div>
                                                        <label htmlFor="phoneNumber" className="block font-semibold text-zinc-200">
                                                            Phone number
                                                        </label>
                                                        <input
                                                            ref={phoneNumberRef}
                                                        ...
                                                        >
                                                            <option value="" disabled selected>Select phone prefix</option>

                                                            {
                                                                Country.overlapping.map((region) =>
                                                                    <option hidden value={region.name}>{region.name} (+{region.code})</option>
                                                                )
                                                            }
                                                ...
                                                <p className="mt-4 text-sm/6 text-gray-500">
                                                    ...
                                                    <a href="#" className="whitespace-nowrap text-zinc-200">
                                                        privacy policy
                                                    </a>
                                                    .
                                                </p>
